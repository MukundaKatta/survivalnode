// survivalnode — tools/compass module
...
export class Compass {
  private readonly options: Required<CompassOptions>;
  ...
  async process(input: unknown): Promise<Record<string, unknown>> {
    ...
    return { status: "success", module: "Compass", result };
  }
  ...
  getStatus(): Record<string, unknown> {
    return { module: "Compass", initialized: this.initialized, dataKeys: [...this.data.keys()] };
  }
